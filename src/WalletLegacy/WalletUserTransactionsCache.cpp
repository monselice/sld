...
//z  std::vector<LegacyDepositInfo> legacyDeposits;
//z  s(legacyDeposits, "deposits");

//z  convertLegacyDeposits(legacyDeposits, m_deposits);
//z  restoreTransactionOutputToDepositIndex();
}
// --------------------------------
