...
#include <hdwallet/ParseArguments.h>
...
Config parseArguments(int argc, char **argv)
{
    ...
    if (cmdOptionExists(argv, argv+argc, "--wallet-file"))
    {
        ...
        {
            std::cout 
				<< "--wallet-file was specified, but no wallet file "
                << "was given!" 
				<< std::endl;
    ...
    if (cmdOptionExists(argv, argv+argc, "--password"))
    {
        ...
        {
            std::cout 
				<< "--password was specified, but no password was "
                << "given!" 
				<< std::endl;
    ...
    if (cmdOptionExists(argv, argv+argc, "--remote-daemon"))
    {
        ...
        {
            std::cout 
				<< "--remote-daemon was specified, but no daemon was "
                << "given!" 
				<< std::endl;
...
{
    return WalletConfig::coinName +  PROJECT_VERSION_LONG + " " + WalletConfig::walletName;
}
////////////////////////////////////////////////////////////////////////////
std::vector<CLICommand> getCLICommands()
{
    ...
    std::sort(commands.begin(), commands.end(), [](const CLICommand &lhs, const CLICommand &rhs)
    {
